  ...
  GetTermAndConditionData() {
    ...
    this.settingService.GetCMSData().subscribe(
      respone => {
        ...
        this.basicContent = this.termData?this.termData[0].termAndCondition:"Welcome Back Mr Admin";
      },
      error => {
        this.loading = false;
        this.addToast({ title: 'Error', msg: error.message, timeout: 5000, theme: 'default', position: 'bottom-right', type: 'error' });
...
// }
// document.getElementsByClassName("nav pcoded-inner-navbar")[0].getElementsByTagName("app-nav-item")[19].getElementsByTagName("li")[0].className = "ng-star-inserted active"
