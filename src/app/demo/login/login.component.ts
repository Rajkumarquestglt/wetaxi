...
export class LoginComponent implements OnInit {
  ...
  ngOnInit() {
    var log = JSON.parse(localStorage.getItem("adminData"));
    var at = JSON.stringify(localStorage.getItem("access_token"));
    if(log && log.type!=null && log.admin_id!=null && log.email!=null && at!=null){
