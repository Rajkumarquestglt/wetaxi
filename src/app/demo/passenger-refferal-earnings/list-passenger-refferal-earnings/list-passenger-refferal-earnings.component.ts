...
@Component({
  selector: 'app-list-passenger-refferal-earnings',
  templateUrl: './list-passenger-refferal-earnings.component.html'
})
export class ListPassengerRefferalEarningsComponent implements OnInit {
