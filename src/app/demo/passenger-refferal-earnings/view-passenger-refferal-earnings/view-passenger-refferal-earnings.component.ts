...
export class ViewPassengerRefferalEarningsComponent implements OnInit {
  ...
  passengerrideearninglist = false;
  filterValue: any = {};
  imageSrc: string = '../../../../assets/images/profile-pic.jpg';
  ...
  ngOnInit() {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.refferalEarningService.GetPassengerReferralEarning(dataTablesParameters).subscribe(
          resp => {
            ...
            this.passengerrideearninglist = resp.data.length > 0 ? true : false;
      ...
      columns: [
        ...
        { data: "referralAmount" },
        { data: "isWithdrawed",orderable: false  },
      ]
    };
  }
  backHierarchy(){
  ...
  getPassengerDetails() {
    ...
    this.passengerService.getPassengerDetails(passengerData).subscribe(
      resp => {
        this.loading = false;
        this.viewPassengerData = resp.data;
        this.imageSrc = this.viewPassengerData.profilePhoto?environment.profileImageUrl + this.viewPassengerData.profilePhoto: this.imageSrc;
