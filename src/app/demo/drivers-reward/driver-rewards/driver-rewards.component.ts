...
// }
@Component({
  selector: 'app-driver-rewards',
  templateUrl: './driver-rewards.component.html'
})
export class DriverRewardsComponent implements OnInit {
...
// console.log(url_id)
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        this.driverService.getDriverListFromReward(dataTablesParameters).subscribe(
          resp => {
            this.loading = false;
  ...
  onFormSubmit() {
    ...
    this.isSubmitted = true;
      this.loading = true;
      let senddata = {title: this.title,description: this.description,type:this.type ,media:this.media, rewardId:this._id,driverIdList: this.checkedList }
      console.log("senddata",senddata)
      this.notifyService.sendRewardToDriverList(senddata)
        .subscribe(next => {
          this.loading = false;
