...
export class SettingService {
  ...
  getCallCenterData(){
    return this.http.get<any>(environment.apiUrl + 'api/getCallCenterDataDetails');
  ...
  updateCallCenterData(data: any) {
    return this.http.post<any>(environment.apiUrl + 'api/updateCallCenterData', data);
  }
