...
@Component({
  selector: "drivermodification",
  templateUrl: "./drivermodification.component.html",
})
export class DriverModificationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.driverService.deleteDriver({driver_id:this.driver_id}).subscribe(response => {
